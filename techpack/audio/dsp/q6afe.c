...
/* Huaqin modify for JD2020-569 to integrate smartPA cal function by xuyuqing at 2019/03/13 start */
...
#endif
/* Huaqin modify for JD2020-569 to integrate smartPA cal function by xuyuqing at 2019/03/13 end */
...
{
	int32_t result, port_id = AFE_PORT_ID_SECONDARY_MI2S_RX;
...
{
	union afe_spkr_prot_config afe_spk_config;
	int32_t port_id = AFE_PORT_ID_SECONDARY_MI2S_RX;
...
{
	union afe_spkr_prot_config afe_spk_config;
	int32_t port_id = AFE_PORT_ID_SECONDARY_MI2S_TX;
